...
public class SetupMsg extends FeaturesAdd {
	// 是否自定义保存
	...
	// 撤销快捷键
	public String backHotKey;
	public List<String> bhkList = new ArrayList<String>();

	// 端口
	public int port;

	public String getBackHotKey() {
		return backHotKey;
	}

	public void setBackHotKey(String backHotKey) {
		this.backHotKey = backHotKey;
	}
	...
	public void setBhkList(List<String> bhkList) {
	...
	public String toString() {
		return "SetupMsg [isCustomizeSave=" + isCustomizeSave + ", customSavePath=" + customSavePath + ", gColor="
				...
				+ ", cancelHotKey=" + cancelHotKey + ", cchkList=" + cchkList + ", backHotKey=" + backHotKey
				+ ", bhkList=" + bhkList + ", port=" + port + "]";
	}
